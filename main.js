...
each(data,function(e,i){
    $("#make").append(`<div class="put"><img class="imgs" id="l${i}"src="${e.imgSrc}" "/><center><input type="checkbox"><input type='button' value='Resize' onclick="resise(${i})"></center> </div>`)
})
